...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__pmain

#else
#  define SWIG_init    init_pmain

#endif
#define SWIG_name    "_pmain"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_pmain(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!SWIG_Python_UnpackTuple(args, "pmain", 0, 0, 0)) SWIG_fail;
  result = (int)pmain();
...
static PyMethodDef SwigMethods[] = {
	 { "pmain", _wrap_pmain, METH_NOARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
