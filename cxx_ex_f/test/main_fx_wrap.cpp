...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__main_fx

#else
#  define SWIG_init    init_main_fx

#endif
#define SWIG_name    "_main_fx"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_main_fx(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!SWIG_Python_UnpackTuple(args, "main_fx", 0, 0, 0)) SWIG_fail;
  result = (int)main_fx();
...
SWIGINTERN PyObject *_wrap_print_hello(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
...
static PyMethodDef SwigMethods[] = {
	 { "main_fx", _wrap_main_fx, METH_NOARGS, NULL},
